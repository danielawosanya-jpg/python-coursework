...
def render_sequence(lead: dict[str, Any]) -> list[dict[str, str]]:
    ...
    emails.append({
        ...
        "body": (
            ...
            f"If it is useful: send me your dec pages, or grab 20 minutes here "
            f"- {AGENCY['calendar_url']} - and I will read them with you and "
            f"tell you plainly which of your current policies I would leave "
            f"alone. Most reviews end with me telling someone to change "
            f"nothing.\n\n"
